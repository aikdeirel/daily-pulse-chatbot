...
export const GoogleIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      <path
        d="M8.159 6.545v2.545h3.545a3.07 3.07 0 01-1.318 2.023l2.127 1.65C13.773 11.636 15 9.636 15 7.182c0-.614-.055-1.205-.159-1.773H8.159z"
        fill="#4285F4"
      />
      <path
        d="M4.836 9.523a4.727 4.727 0 010-3.046L2.709 4.828a7.955 7.955 0 000 6.345l2.127-1.65z"
        fill="#FBBC05"
      />
      <path
        d="M8.159 3.818c1.018 0 1.932.35 2.65 1.036l1.986-1.986C11.636 1.832 10.05 1 8.159 1a7.977 7.977 0 00-5.45 2.173l2.127 1.65a4.754 4.754 0 013.323-1.005z"
        fill="#EA4335"
      />
      <path
        d="M8.159 12.182a4.754 4.754 0 01-3.323-1.005l-2.127 1.65A7.977 7.977 0 008.159 15c1.841 0 3.432-.614 4.573-1.664l-2.127-1.65a4.715 4.715 0 01-2.446.496z"
        fill="#34A853"
      />
    </svg>
  );
