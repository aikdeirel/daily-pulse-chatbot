...
export const AppIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      width={size}
      viewBox="-10 -10 412.533 412.533"
      xmlns="http://www.w3.org/2000/svg"
    >
      <path
        d="M359.372 138.214H207.259V94.966c21.333-4.913 37.236-24.048 37.236-46.804C244.495 21.657 222.968 0 196.333 0s-48.162 21.657-48.162 48.162c0 22.82 15.903 41.891 37.236 46.804v43.249H33.295C2.782 139.896-1.808 166.724.584 177.261l33.099 187.863c2.78 15.903 16.549 27.41 32.711 27.41h259.943c16.162 0 29.931-11.507 32.711-27.41l33.099-187.863c1.681-9.762-1.81-37.172-32.775-39.047M169.958 48.162c0-14.545 11.83-26.376 26.376-26.376s26.376 11.83 26.376 26.376-11.83 26.376-26.376 26.376-26.376-11.896-26.376-26.376m200.598 125.284-33.099 187.863c-.905 5.495-5.689 9.438-11.184 9.438H66.329c-5.56 0-10.279-3.943-11.184-9.438L22.111 173.446c-.646-3.426.453-13.382 11.184-13.382h326.077c12.089.065 11.83 10.021 11.184 13.382"
        fill="#ff8904"
      />
      <path
        d="M106.798 284.19c-14.545 0-26.376-11.83-26.376-26.376s11.83-26.376 26.376-26.376 26.376 11.83 26.376 26.376c-.065 14.61-11.895 26.376-26.376 26.376m177.713 0c-14.545 0-26.376-11.83-26.376-26.376s11.83-26.376 26.376-26.376c14.545 0 26.376 11.83 26.376 26.376s-11.83 26.376-26.376 26.376m-18.553 36.327c-2.069-5.56-8.404-8.404-14.093-6.335-15.58 5.883-35.297 9.115-55.531 9.115s-40.016-3.232-55.531-9.115c-5.624-2.133-11.895.711-14.093 6.335-2.069 5.624.711 11.895 6.335 14.093 18.23 6.852 40.081 10.537 63.289 10.537s45.059-3.62 63.289-10.537c5.623-2.069 8.468-8.404 6.335-14.093"
        fill="#ff8904"
      />
    </svg>
  );
...
export const CalendarIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      <path
        clipRule="evenodd"
        d="M14 2H2C1.44772 2 1 2.44772 1 3V14C1 14.5523 1.44772 15 2 15H14C14.5523 15 15 14.5523 15 14V3C15 2.44772 14.5523 2 14 2ZM14 14V4H2V14H14ZM13 1H3C2.44772 1 2 1.44772 2 2V3H1V14H15V3H14V2C14 1.44772 13.5523 1 13 1ZM4 6H12V7H4V6ZM4 9H12V10H4V9ZM4 12H8V13H4V12Z"
        fill="currentColor"
        fillRule="evenodd"
      />
    </svg>
...
export const GoogleIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      <path
        clipRule="evenodd"
        d="M8.15991 4.36362V6.42908H11.643C11.5175 7.09333 11.1393 7.65579 10.5721 8.03393L12.3029 9.37703C13.3114 8.44613 13.8933 7.07859 13.8933 5.45459C13.8933 5.07645 13.8593 4.71194 13.7959 4.36353L8.15991 4.36362Z"
        fill="currentColor"
        fillRule="evenodd"
      />
      <path
        clipRule="evenodd"
        d="M3.78427 8.34846L3.39388 8.64729L2.01205 9.72367C2.88962 11.4642 4.69527 12.6667 6.77309 12.6667C8.21309 12.6667 9.43707 12.1915 10.3452 11.3774L8.6144 10.0343C8.12007 10.354 7.49065 10.5479 6.77309 10.5479C5.39792 10.5479 4.2333 9.61195 3.78753 8.35179L3.78427 8.34846Z"
        fill="currentColor"
        fillRule="evenodd"
      />
      <path
        clipRule="evenodd"
        d="M2.01199 4.27661C1.64799 4.99391 1.43994 5.81029 1.43994 6.66663C1.43994 7.52298 1.64799 8.33936 2.01199 9.05666C2.01199 9.06066 3.78659 8.34328 3.78659 8.34328C3.67992 8.01995 3.61992 7.67061 3.61992 7.33323C3.61992 6.99585 3.67992 6.64652 3.78659 6.32318L2.01199 4.27661Z"
        fill="currentColor"
        fillRule="evenodd"
      />
      <path
        clipRule="evenodd"
        d="M6.77319 2.78788C7.78068 2.78788 8.69202 3.12788 9.41469 3.80121L10.9413 2.27455C9.43202 0.861212 7.44735 0 6.77319 0C4.69538 0 2.88972 1.19758 2.01205 2.94394L3.78655 4.99001C4.23203 3.72939 5.39655 2.78788 6.77319 2.78788Z"
        fill="currentColor"
        fillRule="evenodd"
      />
    </svg>
...
export const ShareIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      <path
        clipRule="evenodd"
        d="M10 2H6C4.89543 2 4 2.89543 4 4V12C4 13.1046 4.89543 14 6 14H10C11.1046 14 12 13.1046 12 12V4C12 2.89543 11.1046 2 10 2ZM10 12H6V4H10V12ZM13 7H15V9H13V7ZM1 7H3V9H1V7ZM13 10H15V12H13V10ZM1 10H3V12H1V10Z"
        fill="currentColor"
        fillRule="evenodd"
      />
    </svg>
