    ...
    >
      ...
      >
        {message.role === "assistant" && (
          <div className="flex size-10 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-500/20 to-amber-500/20 text-orange-600 ring-1 ring-orange-500/30 dark:from-orange-500/30 dark:to-amber-500/30 dark:text-orange-400 dark:ring-orange-500/40">
                ...
                return (
                  <div key={key}>
                    <MessageContent
                      ...
                      style={
                        message.role === "user"
                          ? { background: "linear-gradient(135deg, hsl(25 85% 50%) 0%, hsl(30 90% 45%) 50%, hsl(20 80% 40%) 100%)" }
                          : undefined
                      }
                    >
        ...
        <div className="flex w-full flex-col gap-3 md:gap-4">
          <div className="flex items-center gap-2 p-0">
            <div className="flex items-center gap-2 rounded-2xl bg-gradient-to-r from-orange-500/15 to-amber-500/15 px-4 py-2.5 text-base dark:from-orange-500/25 dark:to-amber-500/25">
              <span className="animate-pulse bg-gradient-to-r from-orange-600 to-amber-600 bg-clip-text font-medium text-transparent dark:from-orange-400 dark:to-amber-400">Thinking</span>
