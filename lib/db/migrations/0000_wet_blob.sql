...
ALTER TABLE "OAuthConnection" ADD CONSTRAINT "OAuthConnection_userId_User_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "Chat_userId_updatedAt_idx" ON "Chat" USING btree ("userId","updatedAt" DESC NULLS LAST);--> statement-breakpoint
